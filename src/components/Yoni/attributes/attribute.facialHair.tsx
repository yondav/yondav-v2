import { type SVGProps, useMemo, createElement } from 'react';
...
export default function FacialHair({ type, fill }: YoniAttributeProps<FACIALHAIRTYPE>) {
  const elementId = useMemo(() => `facial-hair${type ? `-${type}` : ''}`, [type]);
